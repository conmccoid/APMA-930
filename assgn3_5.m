function [U,V] = assgn3_5(Re,magnitude,type,ssU,ssV)
...
nsteps = tf;  % number of steps with graphic output
%-----------------------------------------------------------------------
...
if strcmp(type,'random')
    V(1,:) = magnitude * (2*rand(size(V(1,:))) - 1);
elseif strcmp(type,'uniform')
    V(1,:) = magnitude * ones(size(V(1,:)));
end
